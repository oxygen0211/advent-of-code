...
for entry in input:
    ...
    for entry in entry.split(' '):
        presentFields.append(entry.split(':')[0])

    byrPresent = 'byr' in presentFields
    iyrPresent = 'iyr' in presentFields
    eyrPresent = 'eyr' in presentFields
    hgtPresent = 'hgt' in presentFields
    hclPresent = 'hcl' in presentFields
    eclPresent = 'ecl' in presentFields
    pidPresent = 'pid' in presentFields

    print('byr: {} iyr: {} eyr: {} hgt: {} hcl: {} ecl: {} pid: {}'.format(byrPresent, iyrPresent, eyrPresent, hgtPresent, hclPresent, eclPresent, pidPresent))

    if byrPresent and iyrPresent and eyrPresent and hgtPresent and hclPresent and eclPresent and pidPresent:
        print('valid')
        validEntrys += 1
